...
export function buildScatterZoomControls(data, onZoomChange) {
  ...
  container.style.cssText = 'display: flex; flex-direction: column; gap: 8px; padding: 8px 4px; background: var(--bg-secondary); border-radius: 8px; align-items: center; min-width: 50px; justify-content: center; height: 100%; flex-shrink: 0;';
